        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('subject_sidebar.php'); ?>
                    ...
                    <div class="control-group">
                    <label class="control-label" for="units">Number of Units</label>

                    <div class="controls">
                      <select name="unit" value="<?php echo $row['unit']; ?>">
                        <option></option>
                        <option <?php if($row['unit'] == 1) echo 'selected="selected"'; ?>>1</option>
                        <option <?php if($row['unit'] == 2) echo 'selected="selected"'; ?>>2</option>
                        <option <?php if($row['unit'] == 3) echo 'selected="selected"'; ?>>3</option>
                        <option <?php if($row['unit'] == 9) echo 'selected="selected"'; ?>>9</option>
                      </select>
                    </div>
                  </div>
