     <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                     <!--   <li> <a href="dashboard.php"><i class="icon-chevron-right"></i><i class="icon-home"></i>&nbsp;Dashboard</a> </li> -->
						...
						<li>
                            <a href="class.php"><i class="icon-chevron-right"></i><i class="icon-group"></i> Class Section</a>
                        </li>
						<li>
						...
						<li>
                            <a href="seatwork.php"><i class="icon-chevron-right"></i><i class="icon-upload"></i> Uploaded Seatworks</a>
                        </li>
						<li>
