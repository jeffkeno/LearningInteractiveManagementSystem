   <div class="row-fluid">
					    ...
					    <?php
                            if (isset($_POST['save'])) {
                                ...
                                mysql_query("insert into teacher (firstname,lastname,location,department_id,username,password)
								values ('$firstname','$lastname','uploads/NO-IMAGE-AVAILABLE.jpg','$department_id','$username','$password')         
								") or die(mysql_error()); ?>
								<script>
