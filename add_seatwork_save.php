...
if ($input_name == ""){
				...
				{		
						...
						mysql_query("insert into notification (teacher_class_id,date_of_notification,link) value('$id[$i]',NOW(),'seatwork_student.php')")or die(mysql_error());               
				 }
}else{
		...
		$name_notification  = 'Add Seatwork file name'." ".'<b>'.$name.'</b>';
            (move_uploaded_file($_FILES['uploaded_file']['tmp_name'], $newname));
				...
				mysql_query("insert into notification (teacher_class_id,notification,date_of_notification,link) value('$id[$i]','$name_notification',NOW(),'seatwork_student.php')")or die(mysql_error()); 
				}				
}
				?>