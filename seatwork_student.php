...
<?php $get_id = $_GET['id']; ?>
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('seatwork_link_student.php'); ?>
                     ...
                     <div class="row-fluid">
					   ...
					   <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Uploaded Seatworks</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
									...
									$count = mysql_num_rows($query);
									if ($count == '0'){?>
									<div class="alert alert-info">No Seatwork Currently Uploaded</div>
									<?php
									}else{
								?>
									...
									?>                              
										<tr>
                                         ...
                                         <td width="220">
										 <form id="assign" method="post" action="submit_seatwork.php<?php echo '?id='.$get_id ?>&<?php echo 'post_id='.$id ?>">
										...
										<?php } ?>
										 <button  data-placement="bottom" title="Submit Seatwork" id="<?php echo $id; ?>submit" class="btn btn-success" name="btn_assign"><i class="icon-upload icon-large"></i> Submit Seatwork</button>
										 </form>
										 </td>                                      
