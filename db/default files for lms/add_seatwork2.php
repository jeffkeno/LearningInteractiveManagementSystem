...
<?php include('dbcon.php'); ?>
    <body id="class_div">
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				<?php include('teacher_add_seatwork_sidebar.php'); ?>
                            ...
                            <div class="block-content collapse in">
                                <div class="span4">
									...
									accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,
										text/plain, application/pd" required>
			...
			jQuery(document).ready(function($){
				$("#add_downloadble").submit(function(e){
					...
					$.ajax({
						type: "POST",
						url: "add_seatwork_save.php",
						data: formData,
						success: function(html){
							console.log(html);
							$.jGrowl("Seatwork Successfully Added", { header: 'Seatwork Added' });
							window.location = 'add_seatwork.php';
						},
    ...
    $(".js-validate-required-radio").each(function () {
        array.push($(this).prop('selector'));
    });
    var uniqueNames = $.unique(array);
    for (var i = 0; i < uniqueNames.length; i++) {
        if ($('input:checkbox[selector=' + uniqueNames[i] + ']:checked').val() == undefined) {
             if (flag) {
                flag = false;
            }
        }
    ...
    return flag;
                              	...
                              	<?php $query = mysql_query("select * from teacher_class
										...
										<tr id="del<?php echo $id; ?>">
											<td width="30">
												<input id="" class="js-validate-required-radio" name="selector" type="checkbox" value="<?php echo $id; ?>">
											</td>
						...
						<?php } ?>
								...
								<hr>
									...
									<div class="control-group">
												<div class="controls">
													<button name="Upload" type="submit" value="Upload" class="btn btn-success" onclick='return validate()' /><i class="icon-upload-alt"></i>&nbsp;Upload</button>
												</div>
									</div>
									</center>
