<div class="span3" id="sidebar">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<!-- commented to remove backpack from teacher sidebar -->
		...
		<li class=""><a href="add_seatwork.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign"></i>&nbsp;Add Seatwork</a></li>
		<li class=""><a href="teacher_quiz.php"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Quiz</a></li>
			<li class=""><a href="teacher_attendance.php"><i class="icon-chevron-right"></i><i class="icon-list"></i>&nbsp;Attendance</a></li>
