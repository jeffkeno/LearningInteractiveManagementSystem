			<form id="login_form1" class="form-signin" method="post">
						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									$.jGrowl("Welcome to the UE Laboratory Interactive Management System", { header: 'Access Granted' });
									var delay = 1000;
									...
									$.jGrowl("A user is already logged in to this PC", { header: 'Login Failed' });
									}else{
			...
			<hr>
				...
				<button data-placement="top" title="Sign In as Student" id="signin_student" onclick="window.location='signup_student.php'" id="btn_student" name="login" class="btn btn-info" type="submit">I`m New Student</button>
