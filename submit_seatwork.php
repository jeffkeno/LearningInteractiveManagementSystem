...
<?php 
	  ...
	  ?>
		<script>
		window.location = "seatwork_student.php<?php echo '?id='.$get_id; ?>";
		</script>
	  <?php
	  }
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									?>
									<div class="alert alert-info">Submit Seatwork in : <?php echo $row1['fname']; ?></div>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
					...
					<?php include('submit_seatwork_sidebar.php') ?>
